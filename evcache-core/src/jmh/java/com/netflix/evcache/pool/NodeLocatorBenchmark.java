...
import com.netflix.evcache.pool.NodeLocatorLookup.FastAVLTreeNodeLocatorLookup;
...
public class NodeLocatorBenchmark {
    ...
    @Param({"legacy", "avltree", "array", "eytzinger", "direct"})
    String locator;
    ...
    static Function<TreeMap<Long, MemcachedNode>, NodeLocatorLookup<MemcachedNode>> findLookupFactory(String locator) {
        ...
        } else if (locator.equals("avltree")) {
            return FastAVLTreeNodeLocatorLookup::new;
