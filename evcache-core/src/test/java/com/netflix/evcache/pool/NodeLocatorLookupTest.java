...
public class NodeLocatorLookupTest {
    ...
    @Test
    public void testFastAVLTreeNodeLocatorLookup() {
        TreeMap<Long, String> map = new TreeMap<>();
        map.put(10L, "node1");
        map.put(20L, "node2");
        map.put(30L, "node3");

        NodeLocatorLookup<String> lookup = new NodeLocatorLookup.FastAVLTreeNodeLocatorLookup<>(map);
    ...
    public void testLargeScaleConsistency() {
        ...
        NodeLocatorLookup<String> fastAvlTreeLookup = new NodeLocatorLookup.FastAVLTreeNodeLocatorLookup<>(map);
        ...
        for (long i = -1000; i <= (numEntries * 100L + 1000); i++) {
            ...
            String fastAvlTreeResult = fastAvlTreeLookup.wrappingCeilingValue(i);
            ...
            assertEquals(arrayResult, fastAvlTreeResult,
                    "Array and FastAVLTree implementations differ for key " + i);
        }
    }
}
